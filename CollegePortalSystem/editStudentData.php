				...
				if ($data = mysqli_fetch_assoc($run)) {
					...
					<form method="POST" action="updateStudentData.php" enctype="multipart/form-data">
						<table>
							...
							<center><img src="images/student/<?php echo $data['image']?>" style="width: 100px; height: 100px; border-radius: 50%;"></center>
							<tr>
								<td>ID</td>
							...
							<tr>
								...
								<td>
									<select name="courseType">
										<option value="java" <?php echo ($data['courseType']=='java')?"checked":""?>>Java</option>
										<option value="python" <?php echo ($data['courseType']=='python')?"checked":""?>>Python</option>
										<option value="php" <?php echo ($data['courseType']=='php')?"checked":""?>>PHP</option>
										<option value="c++" <?php echo ($data['courseType']=='c++')?"checked":""?>>C++</option>
									</select>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="submit" name="submit" value="Update Student Data"></td>
							</tr>
							<tr>
								<td></td>
								<td><button><a href="listStudentData.php" style="text-decoration: none; color: black;">Go Back</a></button></td>
							</tr>
						</table>
					</form>
			<?php } ?>	<?php			
